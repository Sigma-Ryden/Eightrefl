...
TEST(TestBuiltin, TestVectorBool)
{
    ...
    EXPECT("factory-R(size_type, const_reference, allocator_type const&)", reflection->factory.find("std::vector<bool>(unsigned long, bool, std::allocator<bool> const&)") != nullptr);
    EXPECT("factory-R(size_type, const_reference)", reflection->factory.find("std::vector<bool>(unsigned long, bool)") != nullptr);
    EXPECT("factory-R(size_type, allocator_type const&)", reflection->factory.find("std::vector<bool>(unsigned long, std::allocator<bool> const&)") != nullptr);
    EXPECT("factory-R(size_type)", reflection->factory.find("std::vector<bool>(unsigned long)") != nullptr);
