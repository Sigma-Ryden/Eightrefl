#ifndef EIGHTREFL_FUNCTION_HPP
#define EIGHTREFL_FUNCTION_HPP
...
#define CUSTOM_FUNCTION(scope, external_name, internal_name, ... /*function_type*/) \
    { \
        ...
        auto xxfunction = eightrefl::find_or_add_function<__VA_ARGS__>(xxreflection, external_name, xxpointer); \
