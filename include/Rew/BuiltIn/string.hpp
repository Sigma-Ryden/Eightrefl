...
TEMPLATE_REFLECTABLE((template <typename CharType>), std::char_traits<CharType>)
    #ifndef REW_CORE_MINIMAL
    // FUNCTION(assign, void(typename R::char_type&, typename R::char_type))
    ...
    // FUNCTION(lt, bool(typename R::char_type, typename R::char_type))
    ...
    // FUNCTION(to_char_type, typename R::char_type(typename R::int_type))
    // FUNCTION(to_int_type, typename R::int_type(typename R::char_type))
    // FUNCTION(eq_int_type, bool(typename R::int_type, typename R::int_type))
    // FUNCTION(eof, typename R::int_type())
    // FUNCTION(not_eof, typename R::int_type(typename R::int_type))
    #endif // REW_CORE_MINIMAL
REFLECTABLE_INIT()
